...
# ``mlops_stack_example_pub/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_stack_example_pub-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.mlops_stack_example_pub.mlops_stack_example_pub-model", label="Full (Three-Level) Model Name"
)
