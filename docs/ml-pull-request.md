...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_stack_example_pub-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/mlops_stack_example_pub/mlops_stack_example_pub-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/mlops_stack_example_pub/mlops_stack_example_pub-model)
. 
