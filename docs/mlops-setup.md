...
git add README.md docs .gitignore mlops_stack_example_pub/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_stack_example_pub/databricks.yml](../mlops_stack_example_pub/databricks.yml) file.
...
Follow the instructions in [mlops_stack_example_pub/resources/README.md](../mlops_stack_example_pub/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_stack_example_pub/resources/README.md)  to propose, test, and deploy
